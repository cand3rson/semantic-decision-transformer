#!/usr/bin/env python3
"""
GPT-2 Trajectory Predictor Wrapper
===================================

This wrapper makes GPT-2 compatible with the Decision Transformer interface
...
- GPT-2 transformer backbone (instead of custom GPT)
...
class GPT2TrajectoryPredictor(TrajectoryModel):
    """
    GPT-2 based trajectory predictor with Decision Transformer interface.
    
    This model uses GPT-2 to model (Return_1, state_1, action_1, Return_2, state_2, ...)
    exactly like Decision Transformer, but with GPT-2 as the backbone.
    """
    ...
    def __init__(
        ...
        # Create GPT-2 config (same as Decision Transformer)
        ...
        # Use the same GPT2Model as Decision Transformer
        # (positional embeddings removed since we add our own)
    ...
    def forward(self, states, actions, rewards, returns_to_go, timesteps, attention_mask=None, return_agent_emb=False):
        ...
        # Pass through GPT-2 transformer
