#!/bin/bash
# ============================================================================
# PAPER Table II — GPT2 + SEMDT INTENT, λ=0.1
# ============================================================================
# Backbone swap: GPT2 under identical interface and semantic supervision.
# Reproduces Table II entry for GPT2.
# ============================================================================
...
python3 trajectory_experiment_gpt2_vlm.py \
    ...
    --lateral_weight 2.5 \
    --time_weighting none \
    2>&1 | tee training_gpt2_vlm_lambda01_$(date +%Y%m%d_%H%M%S).log
