#!/bin/bash
# ============================================================================
# PAPER Table II — DT + SEMDT INTENT, λ=0.1  (BEST RUN)
# ============================================================================
# The canonical best result: ADE=1.67, FDE=3.27, MR@5m=12.8%
...
python3 trajectory_experiment_visiontrap.py \
    ...
    --lateral_weight 2.5 \
    --time_weighting none \
    2>&1 | tee training_dt_vlm_lambda01_$(date +%Y%m%d_%H%M%S).log
