#!/bin/bash
# Lambda Sensitivity Test: λ = 0.5 (Text-Dominant)
# Testing how aggressive text loss weight affects trajectory prediction
# 
...
python3 trajectory_experiment_visiontrap.py \
    ...
    --enable_plots \
    --save_plots \
    2>&1 | tee training_dt_vlm_lambda_05_descriptive_$(date +%Y%m%d_%H%M%S).log

echo ""
echo "================================================================================"
echo "Lambda 0.5 test completed!"
