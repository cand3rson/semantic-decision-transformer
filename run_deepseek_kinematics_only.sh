#!/bin/bash
# ============================================================================
# PAPER Q1 / Fig. 2 — DEEPSEEK Kinematics-Only Baseline (no semantic grounding)
# ============================================================================
# Runs the DEEPSEEK backbone WITHOUT VisionTRAP text alignment.
...
python3 trajectory_experiment_deepseek_vlm.py \
    ...
    2>&1 | tee training_deepseek_kinematics_only_$(date +%Y%m%d_%H%M%S).log
