#!/bin/bash
# ============================================================================
# PAPER Q1 / Fig. 2 — LLAMA Kinematics-Only Baseline (no semantic grounding)
# ============================================================================
# Runs the LLAMA backbone WITHOUT VisionTRAP text alignment.
...
python3 trajectory_experiment_llama_vlm.py \
    ...
    2>&1 | tee training_llama_kinematics_only_$(date +%Y%m%d_%H%M%S).log
