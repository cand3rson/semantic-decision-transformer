#!/bin/bash
# ============================================================================
# PAPER Table II — QWEN + SEMDT INTENT, λ=0.1
# ============================================================================
# Backbone swap: QWEN under identical interface and semantic supervision.
# Reproduces Table II entry for QWEN.
# ============================================================================
...
python3 trajectory_experiment_qwen_vlm.py \
    ...
    --lateral_weight 2.5 \
    --time_weighting none \
    2>&1 | tee training_qwen_vlm_lambda01_$(date +%Y%m%d_%H%M%S).log
