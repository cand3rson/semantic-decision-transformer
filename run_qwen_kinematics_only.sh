#!/bin/bash
# ============================================================================
# PAPER Q1 / Fig. 2 — QWEN Kinematics-Only Baseline (no semantic grounding)
# ============================================================================
# Runs the QWEN backbone WITHOUT VisionTRAP text alignment.
...
python3 trajectory_experiment_qwen_vlm.py \
    ...
    2>&1 | tee training_qwen_kinematics_only_$(date +%Y%m%d_%H%M%S).log
