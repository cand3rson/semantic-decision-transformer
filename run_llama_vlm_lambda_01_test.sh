#!/bin/bash
# ============================================================================
# PAPER Table II — LLAMA + SEMDT INTENT, λ=0.1
# ============================================================================
# Backbone swap: LLAMA under identical interface and semantic supervision.
# Reproduces Table II entry for LLAMA.
# ============================================================================
...
python3 trajectory_experiment_llama_vlm.py \
    ...
    --lateral_weight 2.5 \
    --time_weighting none \
    2>&1 | tee training_llama_vlm_lambda01_$(date +%Y%m%d_%H%M%S).log
